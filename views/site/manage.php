...
<div class="site-manage">
    ...
    <div class="title-icon d-flex align-items-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" class="bi bi-wrench-adjustable-circle-fill" viewBox="0 0 16 16" aria-hidden="true">
        ...
        <div class="col">
            <div class="card h-100 bg-slate text-light">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item p-2"><?= Html::a('Manage all users', ['user/index']) ?></li>
                    <li class="list-group-item p-2"><?= Html::a('Create new user', ['site/signup']) ?></li>
                </ul>
            </div>
        </div>
        <div class="col">
            <div class="card h-100 bg-slate text-light">
                <div class="card-body d-flex align-items-center mx-auto">
                    <div class="text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" fill="currentColor" class="bi bi-compass-fill" viewBox="0 0 16 16" aria-hidden="true">
