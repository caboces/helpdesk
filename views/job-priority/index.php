...
$this->title = 'Manage Job Priorities';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="job-priority-index">
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-active" role="tabpanel" aria-labelledby="pills-active-tab">
            <div class="subsection-info-block">
                ...
                <p>These priorities are active and can be applied to any tickets</p>
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            [
                                ...
                                'urlCreator' => function ($action, JobPriority $model, $key, $index, $column) {
        ...
        <div class="tab-pane fade" id="pills-inactive" role="tabpanel" aria-labelledby="pills-inactive-tab">
            <div class="subsection-info-block">
                <h2>Inactive priorities</h2>
                <p>These priorities have been disabled. You may still see them on older tickets, but they cannot be applied to new ones</p>
