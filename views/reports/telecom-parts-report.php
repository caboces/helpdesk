...
$this->title = 'Telecom Parts Report';
?>
<div class="reports-telecom-parts-report">
    <div>
        ...
        <p>This report returns the total costs of telecom parts each district or divison used in the specified month and year.</p>
    </div>
    <div>
        <div>
