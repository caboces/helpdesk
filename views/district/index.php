    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-active" role="tabpanel" aria-labelledby="pills-active-tab">
            <div class="subsection-info-block">
                ...
                <p>These districts are active and can be applied to any tickets</p>
        ...
        <div class="tab-pane fade" id="pills-inactive" role="tabpanel" aria-labelledby="pills-inactive-tab">
            <div class="subsection-info-block">
                ...
                <p>These districts have been disabled. You may still see them on older tickets, but they cannot be applied to new ones</p>
