/**
 * 
 * ChangeTicketDraftFieldsHandler.js
 * 
 * Controls ticket draft functionality
 * 
 * Identical to ChangeTicketFieldsHandler.js, however no job_type to update and different field names
 * 
 */

/**
 * ChangeTicketDraftFieldsHandler
 * 
 * makes changes to certain fields in the form depending on the current selection(s)
 * 
 */
const ChangeTicketDraftFieldsHandler = (() => {
    const module = {
        loadEvents: function() {
...
export default ChangeTicketDraftFieldsHandler