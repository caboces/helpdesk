...
/**
 * TicketRecentlyDeletedSearch represents the model behind the search form of `app\models\Ticket`.
 */
class TicketRecentlyDeletedSearch extends Ticket
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'soft_deleted_by_user_id' => $this->soft_deleted_by_user_id,
            'created' => $this->created,
            'modified' => $this->modified,
            // filter out non-deleted tickets
            'ticket.status' => '9'
        ]);
