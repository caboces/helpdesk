...
class Division extends \yii\db\ActiveRecord
{
     ...
     * Gets all divisions
     * 
     * @return all divisions in an alphabetical array
     */
    public static function getDivisions() {
        return Division::find()->orderBy('name ASC')->asArray()->all();
    }

    /**
     * Gets name of division from id
     * 
     * @return the readable name of the division
     */
