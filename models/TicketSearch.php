...
class TicketSearch extends Ticket
{
    ...
    {
        return [
            [['id', 'job_category_id', 'job_priority_id', 'job_status_id', 'job_type_id', 'job_priority_level'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $dataProvider->sort = [
            ...
            'attributes' => [
                'job_category_name' => [
                    'asc' => ['jobCategory.name' => SORT_ASC],
                    'desc' => ['jobCategory.name' => SORT_DESC],
                ],
                'job_priority_level' => [
                ...
                'job_type_name' => [
                    'asc' => ['jobType.name' => SORT_ASC],
                    'desc' => ['jobType.name' => SORT_DESC],
                ],
                'created',
                'modified'
            ]
