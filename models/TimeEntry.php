...
class TimeEntry extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['entry_date'], 'date', 'min' => strtotime('2020/01/01'), 'max' => strtotime(date('Y-m-d', strtotime('tomorrow'))), 'format' => 'php:Y-m-d', 'message' => 'The date must be in the format mm/dd/yyyy.', 'tooSmall' => 'The time entry date must be later than January 1st, 2020.', 'tooBig' => 'The time entry date CANNOT be in the future.'],
